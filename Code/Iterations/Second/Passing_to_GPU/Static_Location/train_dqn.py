...
model = DQN(
    ...
    buffer_size=1000,  # Buffer size to store all experiences
    learning_starts=100,  # Learning starts after 10 steps
    batch_size=50,  # Small batch size
    tau=0.2844690637415575,
    gamma=0.8903399454005295,
    train_freq=10,  # Train after every step
    target_update_interval=50,  # Update target network every 10 steps
...
# Save the model
model.save("C:/Users/alex1/Desktop/Ahmad_Stuff/Drone_Navigation/Code/Iterations/Second/Optuna_optimized/Models/usingGPU3")
